    ...
    <div className="w-full h-screen theme-bg-primary flex flex-col ui-font">
      ...
      <div className="flex items-center justify-between p-6 border-b border-theme-border-primary theme-bg-secondary">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="px-3 py-1.5 text-xs theme-bg-tertiary text-theme-text-secondary rounded hover:theme-bg-quaternary transition-colors"
          ...
          <label className="px-3 py-1.5 text-xs theme-bg-tertiary text-theme-text-secondary rounded hover:theme-bg-quaternary transition-colors cursor-pointer">
      ...
      <div className="flex items-center justify-between p-6 border-t border-theme-border-primary theme-bg-secondary">
        ...
        <div className="flex items-center space-x-2">
          <button
            onClick={onClose}
            className="px-4 py-2 theme-bg-tertiary text-theme-text-secondary rounded hover:theme-bg-quaternary transition-colors text-sm"
          >
            Close
          </button>
        </div>
