// Modern NotesList component - purely presentational
import React, { memo } from 'react'
import { Note } from '../../types'
import { useNotesListLogic } from '../../hooks/useNotesListLogic'

interface NotesListV3Props {
  notes: Note[]
...
const NotesListV3: React.FC<NotesListV3Props> = memo(({
  notes,
  onOpenNote,
  onNewNote,
  selectedNoteId,
...
NotesListV3.displayName = 'NotesListV3'

export default NotesListV3