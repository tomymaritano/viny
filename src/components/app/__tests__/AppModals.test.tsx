...
describe('AppModals', () => {
  ...
  describe('Modal Props', () => {
    it('should pass correct props to search modal', () => {
      const LazySearchModal = vi.mocked(require('../../features/LazyComponents').LazySearchModal)
    ...
    it('should pass correct props to export dialog', () => {
      const LazyExportDialog = vi.mocked(require('../../features/LazyComponents').LazyExportDialog)
    ...
    it('should pass correct props to settings modal', () => {
      const LazySettingsModal = vi.mocked(require('../../features/LazyComponents').LazySettingsModal)
    ...
    it('should pass correct props to tag modal', () => {
      const LazyTagModal = vi.mocked(require('../../features/LazyComponents').LazyTagModal)
    ...
    it('should pass correct props to notebook manager', () => {
      const LazyNotebookManager = vi.mocked(require('../../features/LazyComponents').LazyNotebookManager)
  ...
  describe('Modal Close Handlers', () => {
    ...
    it('should call setModal when closing each modal type', () => {
      const modals = ['export', 'settings', 'tagModal', 'notebookManager'] as const
