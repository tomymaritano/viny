...
describe('Toast', () => {
  ...
  it('maintains proper layout with long messages', () => {
    const longMessage =
      'This is a very long message that might wrap to multiple lines in the toast component'
    const longDetails =
      'These are very long details that provide additional context and might also wrap to multiple lines'

    render(
      <Toast {...defaultProps} message={longMessage} details={longDetails} />
    )
