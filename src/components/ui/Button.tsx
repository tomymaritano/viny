...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-theme-accent-primary text-white hover:bg-theme-accent-primary/90 hover:scale-105 hover:shadow-lg',
        ...
        secondary:
          'bg-theme-bg-secondary text-theme-text-primary hover:bg-theme-bg-tertiary hover:scale-105',
        ...
        glassmorphism:
          'bg-gradient-to-r from-theme-accent-primary/90 to-theme-accent-cyan/90 text-white backdrop-blur-xl border border-white/20 hover:from-theme-accent-primary hover:to-theme-accent-cyan hover:scale-105 hover:shadow-2xl',
      },
      size: {
