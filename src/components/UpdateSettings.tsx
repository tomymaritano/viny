            ...
            <button
              ...
              className={`px-3 py-1 text-xs rounded border transition-colors ${
                updateChannel === channel
                  ...
                  : 'text-theme-text-tertiary border-theme-border-primary hover:bg-theme-bg-tertiary'
              }`}
            >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1 text-xs bg-theme-bg-tertiary text-theme-text-secondary rounded hover:bg-theme-bg-quaternary transition-colors"
          >
