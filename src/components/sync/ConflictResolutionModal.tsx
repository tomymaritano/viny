...
import type { SyncConflict, ConflictResolution } from '../../utils/syncManager'
...
const ConflictResolutionModal: React.FC<ConflictResolutionModalProps> = ({
  ...
  const [selectedStrategy, setSelectedStrategy] =
    useState<ConflictResolution['strategy']>('merge')
      ...
      <div className="space-y-6">
        ...
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-700 dark:text-yellow-300">
            The same {isNote ? 'note' : 'notebook'} was modified both locally
            and remotely. Choose how to resolve this conflict.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            onValueChange={value =>
              setSelectedStrategy(value as ConflictResolution['strategy'])
            }
            className="space-y-3"
          >
