...
describe('RangeSlider', () => {
  ...
  it('applies correct styling classes', () => {
    ...
    const slider = screen.getByRole('slider')
    expect(slider).toHaveClass('flex-1', 'h-2', 'bg-theme-bg-tertiary', 'rounded-lg')
  })
  ...
  it('applies disabled styles when disabled', () => {
    ...
    const slider = screen.getByRole('slider')
    expect(slider).toHaveClass('disabled:opacity-50', 'disabled:cursor-not-allowed')
  })
  ...
  it('renders value display with correct styling', () => {
    ...
    expect(valueDisplay).toHaveClass('text-sm', 'font-medium', 'text-theme-text-primary', 'min-w-[3rem]', 'text-right')
  })
