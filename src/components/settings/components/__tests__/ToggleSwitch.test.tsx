...
describe('ToggleSwitch', () => {
  ...
  it('applies disabled styles when disabled', () => {
    const { container } = render(<ToggleSwitch {...defaultProps} disabled={true} />)
  ...
  it('applies checked background color', () => {
    const { container } = render(<ToggleSwitch {...defaultProps} checked={true} />)
    
    const toggleDiv = container.querySelector('div[class*="peer-checked:bg-theme-accent-primary"]')
    expect(toggleDiv).toBeInTheDocument()
  })
  ...
  it('renders with proper transition classes', () => {
    ...
    const toggleDiv = container.querySelector('div[class*="after:transition-all"]')
    expect(toggleDiv).toBeInTheDocument()
  })
