...
const KeybindingsSettings: React.FC = () => {
  ...
  const categories = Array.from(
    new Set(defaultKeybindings.map(k => k.category))
  )

  const filteredKeybindings = defaultKeybindings.filter(
    kb =>
    ...
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select
              ...
              onValueChange={value => updateSettings({ keymapPreset: value })}
            >
              <SelectTrigger className="w-full px-3 py-2 bg-theme-bg-secondary border border-theme-border-primary rounded-md text-sm text-theme-text-primary focus:outline-none focus:ring-2 focus:ring-theme-accent-primary">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <SwitchWithLabel
            ...
            onCheckedChange={checked =>
              updateSettings({ enableCustomKeybindings: checked })
            }
            label="Enable Custom Keybindings"
            description="Allow overriding default shortcuts with custom ones"
            labelPosition="left"
          />
        </div>
      </div>
      ...
      <div className="space-y-6">
        {categories.map(category => {
          const categoryKeybindings = filteredKeybindings.filter(
      ...
      <div>
        ...
        <div className="space-y-6">
          <SwitchWithLabel
            checked={settings.showKeybindingsInTooltips !== false}
            onCheckedChange={checked =>
              updateSettings({ showKeybindingsInTooltips: checked })
            }
          ...
          <SwitchWithLabel
            ...
            onCheckedChange={checked =>
              updateSettings({ enableGlobalShortcuts: checked })
            }
            label="Enable Global Shortcuts"
            description="Allow shortcuts to work when the app is not focused"
            labelPosition="left"
          />
