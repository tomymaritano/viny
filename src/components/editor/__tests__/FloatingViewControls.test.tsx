...
vi.mock('../../Icons', () => ({
  default: {
    Eye: ({ size }: { size?: number }) => <div data-testid="eye-icon" data-size={size}>Eye</div>,
    EyeOff: ({ size }: { size?: number }) => <div data-testid="eye-off-icon" data-size={size}>EyeOff</div>,
    Sidebar: ({ size }: { size?: number }) => <div data-testid="sidebar-icon" data-size={size}>Sidebar</div>,
    PanelRight: ({ size }: { size?: number }) => <div data-testid="panel-right-icon" data-size={size}>PanelRight</div>
  }
}))
...
describe('FloatingViewControls', () => {
  ...
  it('applies active styles to preview button when in preview mode', () => {
    ...
    expect(previewButton).toHaveClass('text-white', 'border-white/20', 'bg-white/10')
  })
  ...
  it('applies active styles to split button when in split mode', () => {
    ...
    expect(splitButton).toHaveClass('text-white', 'border-white/20', 'bg-white/10')
  })
  ...
  it('is positioned as floating controls', () => {
    ...
    expect(floatingContainer).toHaveClass('fixed', 'bottom-2', 'right-2', 'z-50')
  })
