  ...
  describe('Handler stability', () => {
    it('should provide stable handler references', () => {
      ...
      expect(result.current.handleContentChange).toBe(
        initialHandlers.handleContentChange
      )
      expect(result.current.handleNotebookChange).toBe(
        initialHandlers.handleNotebookChange
      )
      expect(result.current.handleMetadataChange).toBe(
        initialHandlers.handleMetadataChange
      )
    })
  })
