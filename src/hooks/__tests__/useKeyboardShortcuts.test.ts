...
const simulateKeyDown = (key: string, options: { metaKey?: boolean; ctrlKey?: boolean; target?: HTMLElement } = {}) => {
...
describe('useKeyboardShortcuts', () => {
  ...
  describe('Hook Setup and Cleanup', () => {
    ...
    it('should update event listener when dependencies change', () => {
      const { rerender } = renderHook(
        ({ currentNote, ...callbacks }) => useKeyboardShortcuts({
          currentNote,
          ...callbacks
        }),
  ...
  describe('Settings Shortcut (Cmd/Ctrl + ,)', () => {
    ...
    it('should work regardless of currentNote state', () => {
      const { rerender } = renderHook(
        ({ currentNote }) => useKeyboardShortcuts({
          currentNote,
          ...mockCallbacks
        }),
