...
const mockNotes: Note[] = [
  ...
  },
  {
    id: '3',
    title: 'Long Note',
    content: 'This is a very long note content that exceeds the preview length limit and should be truncated when displayed in the preview. It contains lots of text to test the truncation functionality properly.',
...
describe('useNotesListLogic', () => {
  ...
  describe('Date formatting', () => {
    it('should format date with relative option', async () => {
      ...
      expect(formatDate).toHaveBeenCalledWith('2025-01-15T10:00:00Z', { relative: true })
  ...
  describe('Preview text extraction', () => {
    ...
    it('should handle custom max length', () => {
      ...
      expect(preview).toBe('This is a very long note content that exceeds the ...')
  ...
  describe('Edge cases', () => {
    ...
    it('should handle null or undefined notes array', () => {
      const { result: resultNull } = renderHook(() => useNotesListLogic(null as any))
      const { result: resultUndefined } = renderHook(() => useNotesListLogic(undefined as any))
  ...
  describe('Method stability', () => {
    it('should provide stable method references', () => {
      const { result, rerender } = renderHook(() => useNotesListLogic(mockNotes))
