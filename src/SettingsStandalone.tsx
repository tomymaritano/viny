...
type TabId = 'general' | 'themes' | 'editing' | 'preview' | 'keybinding' | 'plugins' | 'sync'
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-theme-bg-secondary rounded-lg p-4 border-2 border-theme-accent-primary cursor-pointer">
              ...
              <div className="bg-theme-bg-secondary rounded-lg p-4 border-2 border-transparent hover:border-theme-border-primary cursor-pointer">
                <h3 className="font-medium text-theme-text-primary mb-2">
                  Light Theme
                </h3>
                <div className="space-y-2">
